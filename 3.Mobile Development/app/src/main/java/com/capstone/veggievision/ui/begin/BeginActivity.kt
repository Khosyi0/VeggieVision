package com.capstone.veggievision.ui.begin
...
import com.capstone.veggievision.databinding.ActivityBeginBinding
...
class BeginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge() // tambah 35dp dari layout xml
        ...
        binding.apply {
            regButton.setOnClickListener {
                startActivity(Intent(this@BeginActivity, RegisterActivity::class.java))
            }
